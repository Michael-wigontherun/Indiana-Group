...
namespace Indiana.Controllers
{
    public class ChameleonCompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Usdot,addminID")] ChameleonCompanies chameleonCompanies)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Usdot,addminID")] ChameleonCompanies chameleonCompanies)
        {
